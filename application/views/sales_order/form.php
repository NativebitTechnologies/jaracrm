        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <span class="float-end">
                    <a href="javascript:void(0);" class="createEntry" data-controller="salesQuotation" data-call_function="getPendingPartyQuotation" data-party_input="party_id"><?=getIcon("plus")?> Sales Quotation</a>
                </span>
