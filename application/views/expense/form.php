    ...
    <div class="col-md-12">
        <div class="row">            
            ...
            <div class="col-md-12 form-group">
                ...
                <select name="exp_by_id" id="exp_by_id" class="form-control selectBox req">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="exp_type" id="exp_type" class="form-control selectBox req">
                ...
                <div class="input-group">
                    ...
                    ?>
                        <div class="input-group-append">
                            <?= '<a href="' . base_url('assets/uploads/expense/'.$dataRow->proof_file) . '" target="_blank"><span style="padding: 10px;" class="form-control bg-primary rounded-rt-1">'.getIcon('download_cloud').'</span></a>'; ?>
                        </div>
                    <?php
                    }
                    ?>
