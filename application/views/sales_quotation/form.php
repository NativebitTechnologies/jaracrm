...
<script src="<?=base_url();?>assets/src/sales-quotation-form.js?v<?=time()?>"></script>
...
if(!empty($dataRow->itemList)):
    foreach($dataRow->itemList as $row):
        ...
        echo '<script>MasterAddRow("salesQuotationItems",'.json_encode($row).',{editBtn:1,deleteBtn:1});</script>'; 
    endforeach;
endif;
?>