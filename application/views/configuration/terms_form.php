    ...
    <div class="col-md-12">
        <div class="row">            
			...
			<div class="col-md-3 form-group">
                ...
                <select name="type" id="type" class="form-control selectBox req ">
                    <?php
            ...
            <div class="col-md-3 form-group">
                ...
                <select name="is_default" id="is_default" class="form-control selectBox">
            ...
            <div class="col-md-12 form-group">
				...
				<textarea name="conditions" id="conditions" class="form-control"><?= (!empty($dataRow->conditions)) ? $dataRow->conditions : "" ?></textarea>
			</div>
		</div>
	</div>
</form>

<!--<script src="<?=base_url()?>assets/src/plugins/src/tinymce/tinymce.min.js"></script>-->
<script>
