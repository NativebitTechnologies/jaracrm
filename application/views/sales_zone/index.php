					...
					<div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
						<div class="widget-content widget-content-area br-8">
								...
								<div class="row">
									<div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
										<form class="form-inline my-2 my-lg-0 justify-content-center">
											<div class="w-100">
												<input type="text" class="w-100 form-control zone-search br-30" id="commanSerach" placeholder="Search...">
											</div>
										</form>
									</div>
									<div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center align-self-center">
										<div class="d-flex justify-content-sm-end justify-content-center">
											<div class="btn-group" role="group">
												...
												<?php $addParam = "{'modal_id' : 'modal-md', 'call_function':'addZone', 'form_id' : 'addZone','fnsave':'saveZone', 'title' : 'Add Sales Zone'}"; ?>
							...
							<div class="table-responsive table-scroll lazy-wrapper">
								<table id="zone-list" class="table dataTable dt-table-hover table-striped table-fixed" style="width:100%">
									...
									<tbody id="productList" class="lazy-load-trans" data-url="<?=base_url('salesZone/getZoneListing');?>" data-length="20" data-post_data="">
									</tbody>
								</table>
							</div>
						</div>
